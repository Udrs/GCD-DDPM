...
class ISICDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # save_image(res.float(),"/media/lscsc/nas/yihan/ddpm_1/MedSegDiff/cmp_test/res.png")
        print(name)
        # save_image(img_A,"/media/lscsc/nas/yihan/ddpm_3/Med_Dif/414/A/A.png")
        # save_image(img_B,"/media/lscsc/nas/yihan/ddpm_3/Med_Dif/414/B/B.png")
        # save_image(img_lbl,f"/media/lscsc/nas/yihan/ddpm_3/Med_Dif/3_28_CD/{name}_loader_CD.png")
        # if self.mode == 'Training':
